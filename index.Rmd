...
- Carmen Reinhart and Kenneth Rogoff paper, <http://www.nber.org/papers/w15639.pdf?new_window=1>
...
## A "significant" or "slight" crisis
...
This talk was produced in [RStudio](http://rstudio.com) version 1.0.136 on `r Sys.Date()`. The code used to generate the slides can be found at <http://github.com/gilmore-lab/cog-bbab-talk-2017-02-22/>. Information about the R Session that produced the code is as follows:
